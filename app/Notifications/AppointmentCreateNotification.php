...
class AppointmentCreateNotification extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        ...
        return [
            ...
            'message' => 'Appointment created by ' . $this->appointment->user->name . ' for ' . $this->appointment->service->name . ' at ' . $appointmentDate->format('Y-m-d') . ' ' . $availableFrom->format('h:i A') . ' to ' . $availableTo->format('h:i A'),
