                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="w-100 form-control @error('slots') is-invalid @enderror" id="slots" name="slots" placeholder="Add Slots" min="1" max="100">
                            @error('slots')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('type_duration') is-invalid @enderror" id="type_duration" name="type_duration" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('type_buffer_time_before') is-invalid @enderror" id="type_buffer_time_before" name="type_buffer_time_before">
                                <option value="mins">Minutes</option>
                                <option value="hours">Hours</option>
                            </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('type_buffer_time_after') is-invalid @enderror" id="type_buffer_time_after" name="type_buffer_time_after">
                                <option value="mins">Minutes</option>
                                <option value="hours">Hours</option>
                            </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="Add description" ></textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
